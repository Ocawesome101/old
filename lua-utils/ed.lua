...
local function promptread()
  io.write("\27[93med: \27[97m")
  return io.read()
end

local function lineread(line)
  io.write("\27[91m " .. line .. "\27[97m ")
  return io.read()
end
...
local function blist()
  for i=1, #buffers, 1 do
    io.write(string.format(" \27[91m%d \27[97m%s\n", i, buffers[i].name))
  end
  return true
end
...
local function bprint(b, l1, l2)
  ...
  for i=(l1 or 1), (l2 or #buffers[b].buffer), 1 do
    io.write(string.format(" \27[91m%d \27[97m%s", i, buffers[b].buffer[i]))
  end
  io.write("\n")
  return true
end
