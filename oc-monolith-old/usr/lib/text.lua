...
-- Pretty sure this puts a \ in front of special chars
...
-- text.split is present in the OpenOS API, but not documented on the wiki. I'm going to leave it out for now.
