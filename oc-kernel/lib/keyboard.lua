...
-- the OpenOS keyboard library, pretty much
keys["1"]           = 0x02
keys["2"]           = 0x03
keys["3"]           = 0x04
keys["4"]           = 0x05
...
kb.pullKey = function() -- It works... I think...
  local n, __, ___, code, name = computer.pullSignal()
  local key = ""
  ...
  return {char = key, player = name, code = code}
end
